...
(custom-theme-set-faces
 ...
 '(region ((t (:foreground "#000000" :background "#666666"))))
 ;'(highlight ((t (:background "#7777aa"))))
 ;'(hl-line ((t (:background "#7777aa"))))
 ...
 '(font-lock-doc-face ((t (:foreground "#7cffd1")))) ; plum
 '(font-lock-doc-string-face ((t (:foreground "#7cffd1")))) ; plum
 '(font-lock-string-face ((t (:foreground "#8ccfd1")))) ; plum
 '(font-lock-keyword-face ((t (:foreground "#727faf")))) ; light sky blue
 '(font-lock-function-number-face ((t (:foreground "#902550" :bold t))))
 '(font-lock-builtin-face ((t (:foreground "#851b5c")))) ; med-dark chocolate
 '(font-lock-function-name-face ((t (:foreground "#902550" :bold t)))) ; dark butter
 '(font-lock-variable-name-face ((t (:foreground "#4ea683"))))
 '(font-lock-preprocessor-face ((t (:foreground "#902550" :bold t)))) ; aluminum
 '(font-lock-constant-face ((t (:foreground "#4ea683" :bold t)))) ; dark chameleon
 '(font-lock-type-face ((t (:foreground "#4ea683")))) ; light plum
 '(font-lock-warning-face ((t (:bold t :foreground "#913360")))) ; Pinkish
...
;;; AUCTeX
 ...
 ;; '(font-latex-string-face ((t (:foreground "#4ea683")))) ; plum
...
;;; post-mode
 ...
 ;; '(post-header-value-face ((t (:foreground "#309090")))) ; dark chameleon
 ;; '(post-header-keyword-face ((t (:foreground "#309090" :bold t)))) ; dark chameleon
 ...
 ;; '(post-double-quoted-text-face ((t (:foreground "#4ea683" :slant normal)))) ; plum
