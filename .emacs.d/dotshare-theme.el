...
(let ((class '((class color) (min-colors 89)))
	  ...
	  (dotshare-red-25 "#882929")
      (dotshare-red-3 "#682424")
      (dotshare-orange "#dfaf8f")
	  (dotshare-brown "#996655")
...
:box (:line-width 1 :color ,dotshare-bg-1)))))
   `(hl-line ((,class (:background ,dotshare-bg+05))))
...
:box (:line-width 1 :color ,dotshare-bg-1)))))
   ...
   `(region ((,class (:foreground "#000000" :background ,dotshare-red-25))))
   ...
   `(font-lock-doc-face ((,class (:foreground ,dotshare-magenta))))
   `(font-lock-doc-string-face ((,class (:foreground ,dotshare-blue+1))))
   `(font-lock-function-name-face ((,class (:foreground ,dotshare-blue-1 :weight bold))))
   ...
   `(font-lock-variable-name-face ((,class (:foreground ,dotshare-red-1))))
...
:box (:line-width 1 :style released-button)))))
   ...
   `(org-level-2 ((,class (:foreground ,dotshare-green))))
   ...
   ;; show-paren
   `(show-paren-mismatch ((,class (:foreground ,dotshare-red+1 :background ,dotshare-red-3 :weight bold))))
   `(show-paren-match ((,class (:foreground ,dotshare-bg :background ,dotshare-blue-1 :weight bold))))
